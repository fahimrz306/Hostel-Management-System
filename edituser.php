            ...
            <div class="card bg-dark text-white" style="border-radius: 1rem;">
              <div class="card-body p-5 text-center">
                ...
                <div class="mb-md-1 mt-md-2 pb-4">
                  ...
                  <h2 class="fw-bold mb-3 text-uppercase">Edit User</h2>
                  <!-- <p class="text-white-50 mb-5">Please enter your login and password!</p> -->

                    <form action="updateuser.php" method="post" enctype="multipart/form-data">
                        <div class="form-outline form-white mb-4">
                            <input type="hidden" id="id" name="id" class="form-control form-control-lg" value="<?php echo $row['id']; ?>" readonly/>
                            <!-- <label class="form-label" for="name">ID</label> -->
                        </div>
                         <div class="form-outline form-white mb-4">
                            <input type="text" id="name" name="name" class="form-control form-control-lg" value="<?php echo $row['name']; ?>"/>
                        ...
                        <div class="form-outline form-white mb-4">
                            <input type="Email" id="email" name="email" class="form-control form-control-lg" value="<?php echo $row['email']; ?>" />
                            <label class="form-label" for="email">Email</label>
                        </div>

                        <div class="form-outline form-white mb-4">
                            <input type="tel" id="phone" name="phone" class="form-control form-control-lg" value="<?php echo $row['phone']; ?>" />
                            <label class="form-label" for="phone">Phone</label>
                        </div>                      
                        <div class="form-outline form-white mb-4">
                            <input type="text" id="nid" name="nid" class="form-control form-control-lg" value="<?php echo $row['nid']; ?>" />
                            <label class="form-label" for="nid">NID</label>
                        </div>
                        <div class="form-outline form-white mb-4">
                            <input type="text" id="seatId" name="seatId" class="form-control form-control-lg" value="<?php echo $row['seatId']; ?>" />
